...
USER hduser
RUN wget -q https://downloads.apache.org/hadoop/common/hadoop-3.3.2/hadoop-3.3.2.tar.gz && tar zxvf hadoop-3.3.2.tar.gz && rm hadoop-3.3.2.tar.gz
...
ENV HADOOP_HOME /home/hduser/hadoop-3.3.2
...
ENTRYPOINT ["/home/hduser/hadoop-3.3.2/etc/hadoop/docker-entrypoint.sh"]
